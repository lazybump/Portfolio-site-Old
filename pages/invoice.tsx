...
import pic from "../public/assets/projects/invoiceBannerImg.jpg";
    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            This app lets users create invoices for their services and is
            responsive on all platforms. Built using React, and Typescript
            following some design files.
          </p>
          <div className="mt-8">
            <a
              href="https://my-invoice-app.netlify.app"
            ...
            <a
              href="https://github.com/lazybump/Invoice-app"
